...
public class BookDelete extends JFrame {
	...
	private JLabel getLabel() {
		if (label == null) {
			...
			label.setIcon(new ImageIcon(BookDelete.class.getResource("/semiIcon/home.PNG")));
			...
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (cnt > 0)
						...
						JOptionPane.showMessageDialog(BookDelete.this , "도서 목록에서 삭제되었습니다.");
						}
					else
						status.setText("오류가 발생하였습니다.");
