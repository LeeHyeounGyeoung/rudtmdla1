...
public class FoodInsert extends JFrame {
			...
			btnAdd.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					try {
						...
						if(tfName.getText().contains(" ") || tInPrice.getText().contains(" ") || 
						...
						String fNameCheck = "[가-헿a-zA-Z_]{1,20}";
	...
	private JLabel getLabel_1() {
		if (label_1 == null) {
			...
			label_1.setIcon(new ImageIcon(FoodInsert.class.getResource("/semiIcon/home.PNG")));
