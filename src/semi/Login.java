...
import semi.AdminMain;
import semi.UserDao;
import semi.UserMain;
...
public class Login extends JFrame {
	...
	private JButton getBtnNewButton_1() {
		if (btnNewButton_1 == null) {
			...
			btnNewButton_1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					UserCreate panel = new UserCreate();
					setVisible(false);
				}
			});
			btnNewButton_1.setBounds(333, 228, 49, 23);
		}
	...
	private JButton getBtnNewButton_2() {
		if (btnNewButton_2 == null) {
			...
			btnNewButton_2.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					FindId panel = new FindId();
					panel.toFront();
					setVisible(false);
				}
			});
			btnNewButton_2.setBounds(333, 283, 49, 23);
		}
	...
	private JLabel getLblNewLabel_3() {
		if (lblNewLabel_3 == null) {
			...
			lblNewLabel_3.setBounds(165, 232, 156, 15);
		}
	...
	private JLabel getLblNewLabel_4() {
		if (lblNewLabel_4 == null) {
			...
			lblNewLabel_4.setBounds(165, 287, 156, 15);
		}
	...
	private JSeparator getSeparator_1() {
		if (separator_1 == null) {
			...
			separator_1.setBounds(22, 205, 360, 2);
		}
		return separator_1;
	}
	private JLabel getLblNewLabel_6() {
		if (lblNewLabel_6 == null) {
			...
			lblNewLabel_6.setIcon(new ImageIcon(Login.class.getResource("/semiIcon/\uCC3E\uAE301.png")));
			lblNewLabel_6.setBounds(104, 275, 49, 38);
		}
	...
	private JLabel getLblNewLabel_5() {
		if (lblNewLabel_5 == null) {
			...
			lblNewLabel_5.setBounds(104, 214, 49, 51);
		}
	...
	private JButton getBtnNewButton_3() {
		if (btnNewButton_3 == null) {
			...
			btnNewButton_3.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					FirstFrame panel = new FirstFrame();
					setVisible(false);
				}
			});
	...
	private JLabel getStatus() {
		if (status == null) {
			...
			status.setBounds(22, 180, 360, 15);
		}
		return status;
	}
}
